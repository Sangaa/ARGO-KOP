# GOV-020 — HERMUZ SESSION WORKGROUP CONTINUATION AMENDMENT
...
Identity migration: from colliding historical path `GOV-013A_HERMUZ_SESSION_WORKGROUP_CONTINUATION_AMENDMENT.md`; authority/status unchanged.
...
`Invocation Phrase → GOV-013 → GOV-020 → PROJECT_BOOTSTRAP → Current State → REP-020/EJR/Matrices/Test State → Highest-Priority Safe Work`
