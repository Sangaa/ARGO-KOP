...
Priority: `10 — Runtime`
State: `CORRECTIVE CANDIDATE / EXACT-HEAD CI PENDING / RESUME-SAFE`
...
| P10-B-C1-01 | `Repository/REP-020_CURRENT_CONTROL_PLANE_BOUNDARY_MANIFEST.md` | UPDATE | synchronize REP-014 binding from v1.2.14 to v1.2.15 | every other manifest row/status/non-claim | PASS | PENDING |
| P10-B-C1-02 | `Repository/REP-011_PRIORITY10_RUNTIME_REL056_DIRECTION_ADDENDUM_2026-09-03_B.md` | UPDATE | preserve first failure and corrective scope | direction evidence and boundaries | PASS | PENDING |
| P10-B-C1-03 | this Matrix | UPDATE IN CORRECTIVE CHANGE SET | preserve failure evidence and satisfy protected-manifest same-change-set enforcement | all original evidence and scope | PASS | PENDING |
