...
| REL-124 | KNW-001 | KNW-002 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-125 | KNW-001 | KNW-004 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-126 | KNW-001 | KNW-005 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-127 | KNW-001 | KNW-009 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-128 | KNW-002 | KNW-001 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-129 | KNW-002 | KNW-004 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-130 | KNW-002 | KNW-005 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-131 | KNW-002 | KNW-009 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-132 | KNW-003 | KNW-001 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-133 | KNW-003 | KNW-002 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-134 | KNW-004 | KNW-001 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-135 | KNW-004 | KNW-002 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-136 | KNW-004 | KNW-003 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-137 | KNW-004 | KNW-005 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-138 | KNW-004 | KNW-009 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-139 | KNW-005 | KNW-001 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-140 | KNW-005 | KNW-002 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-141 | KNW-005 | KNW-004 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-142 | KNW-005 | KNW-009 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-143 | KNW-006 | KNW-001 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-144 | KNW-006 | KNW-004 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-145 | KNW-006 | KNW-005 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-146 | KNW-006 | KNW-009 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-147 | KNW-007 | KNW-001 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-148 | KNW-007 | KNW-002 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-149 | KNW-007 | KNW-004 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-150 | KNW-007 | KNW-005 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-151 | KNW-007 | KNW-009 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-152 | KNW-008 | KNW-001 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-153 | KNW-008 | KNW-003 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-154 | KNW-008 | KNW-004 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-155 | KNW-008 | KNW-005 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-156 | KNW-008 | KNW-009 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-157 | KNW-009 | KNW-001 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-158 | KNW-009 | KNW-002 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-159 | KNW-009 | KNW-004 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-160 | KNW-009 | KNW-005 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-161 | KNW-010 | KNW-001 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-162 | KNW-010 | KNW-004 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-163 | KNW-010 | KNW-005 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-164 | KNW-010 | KNW-006 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-165 | KNW-010 | KNW-007 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-166 | KNW-010 | KNW-008 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
| REL-167 | KNW-010 | KNW-009 | REFERENCES | **P13 DIRECT-SOURCE-REVALIDATED / INTERNAL DOCUMENTARY / NON-DEPENDENCY** |
...
## P13 Knowledge Internal Relationship Registration — 2026-09-05

Priority-13 Transaction B registers the deterministic internal Knowledge documentary cohort validated by the Unit-6 allocation plan.

`REL-124..REL-167` are sourced exclusively from direct current `Related Documents` declarations inside `KNW-001..010` and are all registered as `REFERENCES`.

Semantic boundary:

- a direct Related Documents declaration establishes documentary reference only within this cohort;
- no `DEPENDS_ON`, `CONSUMES`, `GOVERNS`, `OWNS`, execution, authority transfer, or reverse edge is inferred unless independently established by another source contract;
- bidirectional pairs appear only where each direction is directly declared by its own source artifact;
- registration does not promote any KNW maturity/status, does not admit Knowledge to active REP-001 canonical inventory, and does not close Priority 13;
- the exact allocation authority for these IDs remains `Repository/REP-014_PRIORITY13_KNOWLEDGE_INTERNAL_RELATIONSHIP_ALLOCATION_PLAN_2026-09-05_B.tsv` plus its executable guard and Transaction-B Matrix.

`INTERNAL DOCUMENTARY GRAPH != CROSS-LAYER DEPENDENCY GRAPH != AUTHORITY GRAPH != PARTITION CLOSURE`.
