...
2. Keep `REL-061` closed as an intentional one-way relationship unless new authoritative evidence changes its disposition.
3. Keep P4 open until the remaining critical-edge set is either bidirectionally verified or explicitly dispositioned as intentional one-way relationships.
