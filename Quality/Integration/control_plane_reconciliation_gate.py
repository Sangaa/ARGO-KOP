...
def evaluate(root: Path) -> dict:
    ...
    if "Global PASS: **NOT CLAIMED**" not in queue_text and "Global PASS: `NOT CLAIMED`" not in queue_text:
        mismatches.append("REP-016 does not visibly preserve the no-Global-PASS boundary")
